...
public class ConsumerTest {
    public static void main(String[] args) {
        MQClient mqClient = new MQClient(
                ...
                "LTAI5tEsquh4U58d3R5n5HYs",
                // AccessKey Secret，阿里云身份验证密钥。
                "QxRfd3Bn9ajcMo1LWfYBFMgvDsi38O"
        );
        ...
        do {
            ...
            for (Message message : messages) {
                System.out.println("body bytes size:"+message.getMessageBodyBytes().length);
                System.out.println("body:"+message.getMessageBodyString());
